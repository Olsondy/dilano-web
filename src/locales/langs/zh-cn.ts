const local: App.I18n.Schema = {
  ...
  page: {
    ...
    home: {
      ...
      morningGreeting: '早上好，{userName}！🌞 新的一天已经开始！',
      afternoonGreeting: '下午好！{userName}! ☀️, 今天的进度条已过半，加油！',
      eveningGreeting: '晚上好，{userName}！🌙 忙碌了一天，辛苦啦。',
      lastNightGreeting: '夜深了{userName}！🌙 请注意休息。',
