...
export const themeSettings: App.Theme.ThemeSetting = {
  ...
  themeColor: '#000000',
  otherColor: { info: '#000000', success: '#0070f3', warning: '#f5a623', error: '#ee0000' },
  ...
  header: {
    height: 50,
    breadcrumb: { visible: false, showIcon: true },
    multilingual: { visible: false },
    globalSearch: { visible: false }
  },
  tab: { visible: true, cache: true, height: 45, mode: 'chrome' },
  ...
  watermark: { visible: true, text: 'DILANO 迪兰诺', enableUserName: true },
